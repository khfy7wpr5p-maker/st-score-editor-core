...
await buildBrowserArtifact({
  ...
  manifest: Object.freeze({
    ...
    activeStaffAuthoringBundled: true, activeStaffCanonicalAuthority: false,
    activeStaffSelection: 'same-part-same-frame-semantic-only', activeStaffHistoryMutationAuthority: false,
    ...
    measureFrameAuthoringBundled: true, measureFrameAuthoringCanonicalAuthority: false,
    ...
    chordToneAuthoringBundled: true, chordToneAuthoringCanonicalAuthority: false,
    chordToneAdd: 'exact-pitched-event-palette-pitch-one-tone-per-action',
    chordToneSelectionAfterAdd: 'new-exact-note', chordToneHistory: 'EditorSessionV4',
    chordToneRendererCoordinateAuthority: false, chordToneNetworkAuthority: false,
    articulationTogglesBundled: true, articulationTogglesCanonicalAuthority: false,
    articulationToggleKinds: ['staccato', 'accent', 'tenuto'],
    articulationToggleTarget: 'exact-selected-pitched-event-or-note-parent-event',
    ...
    explicitAccidentalsBundled: true, explicitAccidentalsCanonicalAuthority: false,
    explicitAccidentalKinds: ['flat', 'natural', 'sharp'],
    explicitAccidentalTarget: 'exact-selected-note-only',
    explicitAccidentalMutation: 'canonical-pitch-alter-plus-note-notation-accidental-atomic',
    explicitAccidentalStepOctaveMutationAuthority: false, explicitAccidentalAdvancedKeypadTargetAuthority: false,
    explicitAccidentalHistory: 'EditorSessionV4', explicitAccidentalRendererCoordinateAuthority: false, explicitAccidentalNetworkAuthority: false,
    extendedArticulationTogglesBundled: true, extendedArticulationTogglesCanonicalAuthority: false,
    extendedArticulationToggleKinds: ['strong-accent', 'staccatissimo', 'spiccato'],
    extendedArticulationToggleTarget: 'exact-selected-pitched-event-or-note-parent-event',
    extendedArticulationNewSpec: 'auto-placement-null-direction',
    ...
    slurAuthoringBundled: true, slurAuthoringCanonicalAuthority: false,
    slurAuthoringSelection: 'explicit-revision-bound-forward-exact-note-pair', slurAuthoringSelectionModel: 'editor-semantic-selection-v4',
