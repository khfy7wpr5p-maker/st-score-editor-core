...
const defaultRoute = '/st-score-editor-p10-3b-workstation.html';
const allowedAssets = new Map([
  [defaultRoute, Object.freeze({
    file: path.join(browserRoot, 'st-score-editor-p10-3b-workstation.html'),
    contentType: 'text/html; charset=utf-8'
  })],
  ['/st-score-editor-p10-3b-workstation.js', Object.freeze({
    file: path.join(browserRoot, 'st-score-editor-p10-3b-workstation.js'),
...
if (address === null || typeof address === 'string') {
  throw new Error('P10_3B_WEBKIT_SERVER_PORT_MISSING');
}
...
try {
  ...
  await page.goto(
    `http://127.0.0.1:${address.port}/st-score-editor-p10-3b-workstation.html`,
