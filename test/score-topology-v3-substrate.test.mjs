...
const notation=(score)=>createNotationDocumentV2(score,{contractVersion:'2.0.0',documentId:score.id,revisionId:score.revision.id,measures:[
 ...
 {target:addressEntityV2(score,'m2s1'),notation:{timeSignature:null,keySignature:null,clef:null,barlines:[]}},
 {target:addressEntityV2(score,'m2s2'),notation:{timeSignature:null,keySignature:null,clef:null,barlines:[]}}
